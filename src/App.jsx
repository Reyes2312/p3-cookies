...
const App = () => {
  ...
  // This fuction handles the user input - it is executed when the user types into the inputs
  ...
  const handleDelete = (name) => {
    setCount((prevCount) => prevCount + 1); // Changes the value of the depedency variable
